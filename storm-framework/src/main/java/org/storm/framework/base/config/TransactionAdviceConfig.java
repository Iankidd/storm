...
public class TransactionAdviceConfig {
    ...
    /*定义切点变量：拦截org.storm包下所有类的所有方法,返回值类型任意的方法*/
    ...
    public TransactionInterceptor txAdvice() {
        ...
        source.addTransactionalMethod("save*", requireRule);
        source.addTransactionalMethod("set*", requireRule);
        ...
        source.addTransactionalMethod("get*", readOnlyRule);
        source.addTransactionalMethod("query*", readOnlyRule);
        source.addTransactionalMethod("find*", readOnlyRule);
        source.addTransactionalMethod("select*", readOnlyRule);
