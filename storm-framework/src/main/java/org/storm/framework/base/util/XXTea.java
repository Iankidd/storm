...
public class XXTea {
    ...
    private static Logger logger = LoggerFactory.getLogger(XXTea.class);
    ...
    public static byte[] encrypt(byte[] plainData, byte[] key) {
        ...
        return toByteArray(encrypt(toIntArray(plainData, true), toIntArray(key, false)),
                false);
    }
